...
public class ModelProdotto {
	...
	public ModelProdotto(int idprodotto, String nome, String descrizione, String marca, String contenitore, String peso,
			int quantita, float prezzo, int negozio_idNegozio) {
	...
	public ModelProdotto() {
		this(ModelListNegozio.getInstance().getListE().size() + 1, "", "", "", null, "", 0, 0.0f, 0);
	}
	...
	public String toString() {
		return "Prodotto [idprodotto=" + idprodotto.get() + ", nome=" + nome.get() + ", descrizione="
				+ descrizione.get() + ", marca=" + marca.get() + ", contenitore=" + contenitore.get() + ", peso="
				+ peso.get() + ", quantità=" + quantita.get() + ", prezzo=" + prezzo.get() + ", nome Negozio="
				+ nomeNegozio.get() + "]\n";
	}
